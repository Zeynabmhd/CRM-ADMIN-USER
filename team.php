...
$query=mysqli_query($db,"select * from  tbltem");
      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">تیم</span>
                  ...
                  <div class="col-xl-12">
                    <div class="card card-default">
                      <div class="card-header align-items-center">
                        <h2 class="">تیم ما </h2>
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-add-contact"> اضافه کردن تیم 
                        </button>
                      </div>
                      <div class="card-body">
    ...
    <div class="modal-content">
      <form action="team.php" method="post" >
        <div class="modal-header px-4">
          <h5 class="modal-title" id="exampleModalCenterTitle">ایجاد عضو جدید</h5>
        </div>
          ...
          <div class="row mb-2">
            ...
            <div class="col-lg-6">
              <div class="form-group mb-4">
                ...
                <input name="code" class="form-control" id="email">
              </div>
            </div>

            <div class="col-lg-6">
              <div class="form-group mb-4">
                <label for="Birthday">تلفن همراه </label>
                <input for="password" name="phone" class="form-control" id="password" >
              </div>
            </div>
            <div class="col-lg-6">
              <div class="form-group mb-4">
                <label for="Birthday">سمت شغلی</label>
                <input for="password" name="semat" class="form-control" id="password" >
              </div>
            </div>

            <div class="col-lg-6">
              <div class="form-group mb-4">
                <label for="event"> ایمیل</label>
                <input  name="email" class="form-control" id="event" >
              </div>
            </div>
          </div>
        </div>
        <div class="modal-footer px-4">
          ...
          <button type="submit" name="btnadd" class="btn btn-primary btn-pill"> ذخیره تیم</button>
        </div>
      </form>
    </div>
  </div>
...
if(isset($_POST['btnadd'])) {
    ...
    mysqli_query($db,"INSERT INTO  tbltem(`flname`,`code`,`phone`,`semat`,`email`) 
    VALUES ('$flname','$code','$phone','$semat','$email')");

        echo "<script>alert('ثبت  شما با موفقیت انجام شد')</script>";
