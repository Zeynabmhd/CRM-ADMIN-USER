      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title"> پروفایل کاربر</span>
...
<div class="card card-default card-profile">
  ...
  <div class="card-body card-profile-body">
    ...
    <div class="profile-avata">
      ...
      <span class="h5 d-block mt-3 mb-2"><?= $_SESSION['login'] ?> </span>
  ...
  <div class="card-footer card-profile-footer">
    <ul class="nav nav-border-top justify-content-center">
      <li class="nav-item">
        <a class="nav-link active" href="user-profile.php">پروفایل</a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="user-profile-settings.php">تنظیمات</a>
      </li>
  ...
  <div class="col-lg-12">
    ...
    <div class="card card-default pb-4" id="todo">
      <div class="card-header mb-3">
        ...
        <a class="btn btn-primary btn-pill" id="add-task" href="#" role="button">افزودن وظیفه جدید </a>
      </div>
      ...
      <div class="card-body" data-simplebar style="height: 385px;">
        <div class="todo-single-item d-none" id="todo-input">
          <form>
            <div class="form-group">
              <input type="text" class="form-control" placeholder="وظیفه جدید وارد کنید" autofocus>
            </div>
          </form>
        </div>
        <div class="todo-list" id="todo-list">
          <div class="todo-single-item d-flex flex-row justify-content-between finished">
            <i class="mdi"></i>
            <span>به‌روزرسانی کیت رابط کاربری داشبورد را تمام کنید</span>
            <span class="badge badge-primary">تمام شده</span>
          </div>
          <div class="todo-single-item d-flex flex-row justify-content-between current">
            <i class="mdi"></i>
            <span>نمونه اولیه جدیدی برای صفحه فرود ایجاد کنید</span>
            <span class="badge badge-primary">امروز</span>
          </div>
          <div class="todo-single-item d-flex flex-row justify-content-between ">
            <i class="mdi"></i>
            <span> کد گوگل آنالیتیکس جدید را به همه فایل های اصلی اضافه کنید</span>
            <span class="badge badge-danger">دیروز</span>
          </div>

          <div class="todo-single-item d-flex flex-row justify-content-between ">
            <i class="mdi"></i>
            <span>به روز رسانی پیمایش اختلاف منظر در صفحه تیم</span>
            <span class="badge badge-success">1402-1-5 </span>
          </div>

          <div class="todo-single-item d-flex flex-row justify-content-between ">
            <i class="mdi"></i>
            <span> فهرست مشتریان آنلاین ایجاد کنید</span>
            <span class="badge badge-success">1402-1-10</span>
          </div>
          <div class="todo-single-item d-flex flex-row justify-content-between ">
            <i class="mdi"></i>
            <span>فهرست موجودی کالا بروز رسانی کنید</span>
            <span class="badge badge-success">1402-1-15</span>
          </div>
          <div class="todo-single-item d-flex flex-row justify-content-between ">
            <i class="mdi"></i>
            <span>سئو سایت را بررسی کنید</span>
            <span class="badge badge-success">1402-1-20</span>
          </div>
