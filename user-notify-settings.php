...
<html lang="en" dir="ltr">
  ...
  <title>تنظیمات اعلان های کاربر</title>
      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">تنظیمات اعلان های کاربر</span>
...
<div class="card card-default card-profile">
  ...
  <div class="card-footer card-profile-footer">
    <ul class="nav nav-border-top justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="user-profile-settings.php">تنظبمات</a>
      </li>
...
<div class="row">
        ...
        <ul class="nav nav-settings">
          ...
          <li class="nav-item">
            <a class="nav-link" href="user-account-settings.php">
              <i class="mdi mdi-settings-outline mr-1"></i> تنظبمات حساب کاربری
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link active" href="user-notify-settings.php">
  ...
  <div class="col-xl-9">
    ...
    <div class="card card-default">
      <div class="card-header">
        <h2 class="mb-5">تنظبمات اعلان ها</h2>

      </div>

      <div class="card-body">
        <ul class="list-underline">
          <li class="list-item">یک نفر شما را دنبال می کند
          ...
          <li class="list-item">
            یک نفر شما را به یک تیم دعوت می کند
            <label class="switch switch-primary switch-pill form-control-label">
              <input type="checkbox" class="switch-input form-check-input" value="on" >
              <span class="switch-label"></span>
              <span class="switch-handle"></span>
