...
<html lang="en" dir="ltr">
  ...
  <title> تنظیمات پروفایل کاربر</title>
      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">تنظبمات پروفایل کاربر  </span>
...
<div class="row">
    ...
    <div class="card card-default">
      ...
      <div class="card-body pt-0">
        <ul class="nav nav-settings">
          <li class="nav-item">
            <a class="nav-link active" href="user-profile-settings.php">
  ...
  <div class="col-xl-9">
    <div class="card card-default">
      <div class="card-header">
        <h2 class="mb-5">تنظیمات پروفایل</h2>
      ...
      <div class="card-body">
        ...
        <form>
          <div class="form-group row mb-6">
            <label for="coverImage" class="col-sm-4 col-lg-2 col-form-label">تصویر</label>
            <div class="col-sm-8 col-lg-10">
              ...
              <span class="d-block ">یک تصویر جلد جدید آپلود کنید, JPG 1200x300</span>
            </div>
          </div>

          <div class="form-group row mb-6">
            <label for="occupation" class="col-sm-4 col-lg-2 col-form-label">شغل</label>
            <div class="col-sm-8 col-lg-10">
          ...
          <div class="form-group row mb-6">
            <label for="com-name" class="col-sm-4 col-lg-2 col-form-label"> نام شرکت</label>
            <div class="col-sm-8 col-lg-10">
          ...
          <div class="d-flex justify-content-end">
            <button type="submit" class="btn btn-primary mb-2 btn-pill">بروزرسانی پروفایل</button>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="d-flex mb-5">
                  ...
                  <input type="text" class="form-control" placeholder="نام کاربری فیسبوک">
                </div>
                ...
                <div class="d-flex mb-5">
                  ...
                  <input type="text" class="form-control" placeholder="نام کاربری گوگل پلاس">
                </div>
                ...
                <div class="d-flex mb-5">
                  ...
                  <input type="text" class="form-control" placeholder="نام کاربری ویمو">
                </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="d-flex mb-5">
                  ...
                  <input type="text" class="form-control" placeholder="نام کاربری توییتر">
                </div>
                ...
                <div class="d-flex mb-5">
                  ...
                  <input type="text" class="form-control" placeholder="نام کاربری لینکدین">
                </div>
                ...
                <div class="d-flex mb-5">
                  ...
                  <input type="text" class="form-control" placeholder="نام کاربری پینترست">
                </div>
