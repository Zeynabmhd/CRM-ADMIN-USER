      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title"> نوشتن ایمیل</span>
      ...
      <div class="col-lg-8 col-xl-9 col-xxl-10">
        <div class="email-right-column  email-body p-4 p-xl-5">
          <div class="email-body-head mb-5 ">
            <h4 class="text-dark">نامه جدید</h4>
          </div>
          <form class="email-compose">
            <div class="form-group">
              <input type="email" class="form-control" id="exampleEmail" placeholder="به: ">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" id="exampleSubject" placeholder="موضوع ">
            </div>
            <div id="standalone">
              <div id="toolbar">
            ...
            <div class="email-attachment mt-4 mb-3">
              ...
              <span class="text-dark d-inline-block font-weight-medium pl-2">پیوست</span>
            </div>
          </form>
          <div class="border rounded mb-5">
            <form action="./" class="dropzone"></form>
          </div>
          <button class="btn btn-primary btn-pill mb-5" type="submit"> ارسال</button>
        </div>
      </div>
    </div>
  </div>
