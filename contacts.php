...
$query=mysqli_query($db,"select * from  tblusers");
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#authentication"
                      ...
                      <span class="nav-text">احراز هویت</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="authentication"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="reset-password.php">
      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">مخاطب</span>
...
<div class="content-wrapper">
  <div class="content"><div class="card card-default">
    <div class="card-header align-items-center px-3 px-md-5">
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-add-contact"> اضافه کردن مخاطب 
      </button>
    </div>
        ...
        <div class="col-lg-8 col-xl-6">
          <div class="card card-default p-4">
            <a href="javascript:0" class="media text-secondary" data-toggle="modal" data-target="#modal-contact">
              ...
              <div class="media-body">
                <h5 class="mt-0 mb-2 text-dark"><?php  echo $row['flname'];?></h5>
        ...
        <div class="row no-gutters">
            ...
            <div class="profile-content-left px-4">
              <div class="card text-center px-0 border-0">
                ...
                <div class="card-body">
                  ...
                  <a class="btn btn-primary btn-pill btn-lg my-4" href="javascript:void(0)">دنبال کردن</a>
                </div>
							</div>
          ...
          <div class="col-md-6">
            <div class="contact-info px-4">
              <h4 class="mb-1">جزئیات مخاطب</h4>
              <p class="text-dark font-weight-medium pt-4 mb-2"> آدرس ایمیل</p>
              <p>Albrecht.straub@gmail.com</p>
              <p class="text-dark font-weight-medium pt-4 mb-2">شماره تلفن </p>
              <p>+99 9539 2641 31</p>
              <p class="text-dark font-weight-medium pt-4 mb-2">کد ملی </p>
              <p>Nov 15, 1990</p>
    ...
    <div class="modal-content">
      <form action="contacts.php" method="post" >
        <div class="modal-header px-4">
          <h5 class="modal-title" id="exampleModalCenterTitle">ایجاد مخاطب جدید</h5>
        </div>
          ...
          <div class="row mb-2">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input  name="flname" class="form-control" id="firstName" >
              </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
              <div class="form-group mb-4">
                <label for="Birthday">رمزعبور </label>
                <input for="password" name="pass" class="form-control" id="password" >
              </div>
            </div>
            <div class="col-lg-6">
              <div class="form-group mb-4">
                <label for="Birthday">رمزعبورتکرار</label>
                <input for="password" name="confpassword" class="form-control" id="password" >
              </div>
            </div>

            <div class="col-lg-6">
              <div class="form-group mb-4">
                <label for="event">تلفن همراه</label>
                <input  name="phone" class="form-control" id="event" >
              </div>
            </div>
          </div>
        </div>
        <div class="modal-footer px-4">
          ...
          <button type="submit" name="btnadd" class="btn btn-primary btn-pill"> ذخیره مخاطب</button>
        </div>
      </form>
    </div>
  </div>
...
if(isset($_POST['btnadd'])) {
    ...
    if($pass!= $confpassword){
      ...
      //  mysqli_query($db,"INSERT INTO tblusers(`flname`,`codmeli`,`phone`,`email`,`pass`)
      //     VALUES ('g','125','0252','a@gmail.com','0000')");


    mysqli_query($db,"INSERT INTO  tblusers(`flname`,`phone`,`email`,`pass`) 
    VALUES ('$flname','$phone','$email','$pass')");
