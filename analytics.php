...
<html lang="en" dir="ltr">
  ...
  <title>داشبورد تجزیه و تحلیل</title>
      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">تجزیه و تحلیل</span>
                    ...
                    <div class="card card-default" id="user-acquisition">
                      <div class="card-header border-bottom pb-0">
                        ...
                        <ul class="nav nav-underline-active-primary" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#traffic-channel" role="tab" aria-selected="true">کانال ترافیک
                              </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#source-medium" role="tab" aria-selected="false">منبع / رسانه </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#referrals" role="tab" aria-selected="false">ارجاعات</a>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div class="card-footer d-flex flex-wrap bg-white">
                        <a href="#" class="text-uppercase py-3"> گزارش کسب</a>
                      </div>
                    </div>
                  ...
                  <div class="col-xl-6">
                      ...
                      <div class="card card-default">
                        <div class="card-header border-bottom">
                          <h2 class="mdi mdi-desktop-mac"> جلسات بر اساس دستگاه</h2>
                        </div>
